namespace RabbetGameEngine
{
    public class GUIBindingsSettings : GUI
    {
        ...
        public GUIBindingsSettings() : base("bindingSettings", "arial")
        {
            ...
            addGuiComponent("title", new GUITextPanel(0, 0, guiFont, ComponentAnchor.CENTER_TOP, 1).addLine("Bindings Settings").setFontSize(0.4F).setDefaultLineColor(Color.white));
