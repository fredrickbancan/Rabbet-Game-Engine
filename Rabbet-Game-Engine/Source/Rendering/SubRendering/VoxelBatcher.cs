...
namespace RabbetGameEngine
{
    ...
    public class VoxelBatcher
    {
        ...
        public VoxelBatcher(Chunk parentChunk)
        {
            ...
            VertexBufferLayout vfbl = new VertexBufferLayout();
                ...
                for (int z = 0; z < Chunk.CHUNK_SIZE; z++)
                {
                    ...
                    for (int y = 0; y < Chunk.CHUNK_SIZE; y++)
                    {
                        ...
                        for (i = 0; i < 6; i++)
                        {
                            ...
                            {
                                voxelFaceBuffer[addedVoxelFaceCount++] = new VoxelFace((byte)x, (byte)y, (byte)z, parentChunk.getLightLevelAtSafe(offset), 0, (byte)i, 0);
                            }
                        }
                    }
                }
