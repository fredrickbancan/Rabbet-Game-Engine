...
namespace RabbetGameEngine
{
    ...
    public static class ShaderUtil
    {
        ...
        public static readonly string text3DName = "StaticText3D";
        public static readonly string lerpText3DName = "LerpText3D";
        public static readonly string trianglesName = "Static";
        public static readonly string quadsName = "Static";
        public static readonly string linesName = "StaticLines";
        public static readonly string iSpheresName = "StaticISpheres";
        public static readonly string iSpheresTransparentName = "StaticISpheres_T";
        public static readonly string lerpISpheresName = "LerpISpheres";
        public static readonly string lerpTrianglesName = "Lerp";
        public static readonly string lerpQuadsName = "Lerp";
        public static readonly string lerpLinesName = "Lerp";
        public static readonly string lerpISpheresTransparentName = "LerpISpheres_T";
        public static readonly string lerpTrianglesTransparentName = "Lerp_T";
        public static readonly string lerpQuadsTransparentName = "Lerp_T";
        public static readonly string trianglesTransparentName = "Static_T";
        public static readonly string quadsTransparentName = "Static_T";
        public static readonly string spriteCylinderName = "StaticSpriteCylinder";
