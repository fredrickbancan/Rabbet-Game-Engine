namespace RabbetGameEngine
{
    public class GUIControlsSettings : GUI
    {
        ...
        public GUIControlsSettings() : base("conSet", "arial")
        {
            ...
            addGuiComponent("ttl", new GUITextPanel(0, 0, guiFont, ComponentAnchor.CENTER_TOP, 1).addLine("Controls Settings").setFontSize(0.4F).setDefaultLineColor(Color.white));
            ...
            addGuiComponent("binBut", bindingsButton);
