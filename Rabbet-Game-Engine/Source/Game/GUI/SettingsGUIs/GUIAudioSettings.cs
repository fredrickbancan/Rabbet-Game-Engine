namespace RabbetGameEngine
{
    public class GUIAudioSettings : GUI
    {
        ...
        public GUIAudioSettings() : base("audSet", "arial")
        {
            ...
            addGuiComponent("ttl", new GUITextPanel(0, 0, guiFont, ComponentAnchor.CENTER_TOP, 1).addLine("Audio Settings").setFontSize(0.4F).setDefaultLineColor(Color.white));
