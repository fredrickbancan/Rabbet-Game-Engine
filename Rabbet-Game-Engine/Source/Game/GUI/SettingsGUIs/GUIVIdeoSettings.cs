namespace RabbetGameEngine
{
    public class GUIVideoSettings : GUI
    {
        ...
        public GUIVideoSettings() : base("vidSet", "arial")
        {
            addGuiComponent("bgr", new GUITransparentOverlay(Color.black, 0.7F, 1));
            addGuiComponent("ttlb", new GUITransparentRectangle(0, 0, 1.5F, 1.0F, Color.black.setAlphaF(0.7F), ComponentAnchor.CENTER, 1));
            addGuiComponent("ttl", new GUITextPanel(0, 0, guiFont, ComponentAnchor.CENTER_TOP, 2).addLine("Video Settings").setFontSize(0.4F).setDefaultLineColor(Color.white));
